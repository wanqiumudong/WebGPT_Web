...
DEFECT_CODE_ROOT = Path(__file__).resolve().parents[1]
DEFECT_DATA_ROOT = DEFECT_CODE_ROOT.parent / "data"
...
def load_mvtec_dataset(args):
    ...
    data = globals()[dataset_name](data_path, tokenizer, args['max_length']) #SupervisedDataset
    '''
    data = MVtecDataset(str(DEFECT_DATA_ROOT / "SEM"))
...
def load_supervised_dataset_with_cn(args):
    ...
    data = globals()[dataset_name](data_path, tokenizer, args['max_length']) #SupervisedDataset
    '''
    data = all_supervised_with_cn.SupervisedDataset('../data')
    # data = all_supervised_with_cn.SupervisedDataset('/data/yqjiang/project/AnomalyGPT/data/all_anomalygpt')
