...
args = {
    ...
    'anomalygpt_ckpt_path': '/data/share/to_xiaolei/FabGPT/code/ckpt/pytorch_model.pt'
...
with gr.Blocks() as demo:
    gr.HTML("""<h1 align="center">DTCO-GPT</h1>""")
        ...
        with gr.Column(scale=3):
            with gr.Row():
                ...
                with gr.Column(scale=4):
                    # gr.Image(output)
                    image_output = gr.Image(interactive=False, label="Localization Output", every=1.0, shape=[224,224], type='pil',value=PILImage.open('/data/yqjiang/project/GPTAnomaly-main/code/ffffff.png'))
            with gr.Row():
