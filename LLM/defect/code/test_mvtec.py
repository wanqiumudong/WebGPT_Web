...
describles = {}
describles['SEM-image'] = "This is an SEM image of a wafer for anomaly detection, which should be intact, without any damage, flaw, defect, scratch, hole, or broken region."
...
args = {
    ...
    'anomalygpt_ckpt_path': '/data/Web-FabGPT/LLM/defect/code/ckpt-TCAD/unsupervised-sem/pytorch_model.pt',
...
root_dir = '/data/Web-FabGPT/LLM/defect/data/SEM'
...
CLASS_NAMES = ['SEM-image', 'bottle', 'cable', 'capsule', 'carpet', 'grid','hazelnut', 'leather', 'metal_nut', 'pill', 'screw','tile', 'toothbrush', 'transistor', 'wood', 'zipper']

precision = []

for c_name in CLASS_NAMES:
    normal_img_paths = ["/data/Web-FabGPT/LLM/defect/data/SEM/"+c_name+"/data/Web-FabGPT/LLM/defect/data/SEM/"+c_name+"/train/good/"+str(command_args.round * 4 + 1).zfill(3)+".png",
                        "/data/Web-FabGPT/LLM/defect/data/SEM/"+c_name+"/train/good/"+str(command_args.round * 4 + 2).zfill(3)+".png", "/data/Web-FabGPT/LLM/defect/data/SEM/"+c_name+"/train/good/"+str(command_args.round * 4 + 3).zfill(3)+".png"]
