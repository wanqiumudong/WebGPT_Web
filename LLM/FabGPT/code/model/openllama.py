...
class OpenLLAMAPEFTModel(nn.Module):
    ...
    def __init__(self, **args):
        ...
        # self.llama_model = LlamaForCausalLM.from_pretrained(vicuna_ckpt_path, torch_dtype=torch.float16, device_map="auto", load_in_8bit=True
        # )
        ...
        self.prompts_sim = nn.Parameter(torch.randn((1, 4096)), requires_grad=True)
