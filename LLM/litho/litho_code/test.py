...
if __name__ == "__main__":
    args=['evaluate', '--mask', "/data/Web-FabGPT/LLM/litho/litho_code/output_image/M1_test1_mask.png", '--target', '/data/Web-FabGPT/LLM/litho/litho_code/thirdparty/OpenILT/benchmark/ICCAD2013/M1_test1.glp']
    # test_args=["optimize","--target","M1_test1.glp","--model","simpleilt",  "--tile_sizeX","2048","--tile_sizeY","2048","--output_format","printedNom"]
    # args=["simulate","--mask","/data/Web-FabGPT/LLM/litho/litho_code/output_image/M1_test1_mask.png", "--tile_sizeX","2048","--tile_sizeY","2048","--output_format","printedNom"]
    instruction(args)
    # markdown()    
    # test()
    # test_online()
