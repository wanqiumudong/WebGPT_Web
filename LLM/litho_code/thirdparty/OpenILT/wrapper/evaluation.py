...
class Basic: 
    def __init__(self, litho=lithosim.LithoSim(openilt_root_path+"./config/lithosimple.txt"), thresh=0.5, device=DEVICE): 
        self._litho  = litho
        self._thresh = thresh
        self._device = device
...
def evaluate_wrapper(maskfile,targetfile):
    ...
    output_message=f"Result: L2 {l2:.0f}; PVBand {pvb:.0f}; EPE {epe:.0f}; Shot: {shot:.0f}"
